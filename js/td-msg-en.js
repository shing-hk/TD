...
_TD.a.push(function (TD) {
	...
	TD._msg_texts = {
		...
		"building_name_super_gun": "Super gun", //new weapon
		//"building_info": "${0}: Level ${1}, Damage ${2}, Speed ${3}, Range ${4}, Kill ${5}",
		"building_info": "${0}: Lv ${1}, Dmg ${2}, Spd ${3}, Rng ${4}, KO ${5}",
		...
		"building_intro_super_gun": "Super gun: greatest damage, 100% hit ($${0})", //new weapon
		...
		"monster_info": "Monster: Lf ${0}, Shd ${1}, Spd ${2}, Dmg ${3}",
